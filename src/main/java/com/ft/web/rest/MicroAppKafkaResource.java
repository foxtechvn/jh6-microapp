...
@RestController
@RequestMapping("/api/micro-app-kafka")
public class MicroAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MicroAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MicroAppKafkaResource(KafkaProperties kafkaProperties) {
